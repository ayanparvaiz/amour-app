...
/// Editing the signed-in member's own profile — every field the website's
/// settings page edits. The settings *menu* is a separate screen.
class EditProfileController extends GetxController {
  EditProfileController({ImagePicker? picker, GeolocatorPlatform? geolocator})
