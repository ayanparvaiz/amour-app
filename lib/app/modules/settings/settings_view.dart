...
class _PhotosSection extends GetView<SettingsController> {
  const _PhotosSection();
...
class _PhotoTile extends GetView<SettingsController> {
...
class _BasicsSection extends GetView<SettingsController> {
  const _BasicsSection();
...
class _LocationSection extends GetView<SettingsController> {
  const _LocationSection();
...
class _InterestsSection extends GetView<SettingsController> {
  const _InterestsSection();
...
class _LifestyleSection extends GetView<SettingsController> {
  const _LifestyleSection();
